...
<head>
    ...
    <!-- FontAwesome Styles-->    <link href="assets/css/font-awesome.css" rel="stylesheet" />
    <!-- Morris Chart Styles-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand waves-effect waves-dark" href="index1.php"><i class="large material-icons"></i> <strong>NEWS</strong></a>
...
<li><a href="php/controller/logout.php?id1=table"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
</li>
</ul>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="table.php" class="active-menu waves-effect waves-dark"><i class="fa fa-table"></i> 新闻预览</a>
                    </li>
                    <li>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-action">
                            <font color="#FF9999"><h3>新闻信息</h3></font>
                        </div>
                        <div class="card-content">   
						<form action="php/controller/update.php?id=<?php echo $id;?>" method="post">
							<font color="#FFCCCC"><h4>标题:</h4></font> <input type="text" id="biaoti" name="biaoti" value="<?php echo $rs->title;?>"><br>
							<font color="#FFCCCC"><h4>作者:</h4></font> <input type="text" id="zuozhe" name="zuozhe" value="<?php echo $rs->author;?>"><br>
							<font color="#FFCCCC"><h4>备注:</h4></font> <input type="text" id="beizhu" name="beizhu" value="<?php echo $rs->remarkes;?>"><br>
							<font color="#FFCCCC"><h4>内容:</h4></font> <br><textarea id="neirong" name="neirong"><?php echo $rs->content;?></textarea><br><br>
