...
<li><a href="php/controller/logout.php?id1=tab-panel"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
</li>
</ul>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="tab-panel.php" class="active-menu waves-effect waves-dark"><i class="fa fa-qrcode"></i> 新闻目录</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#" class="waves-effect waves-dark">查询</a>
                            </li>
                            <li>
                                <a href="#" class="waves-effect waves-dark">修改</a>
                            </li>
                            <li>
