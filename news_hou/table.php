...
.box{
	...
	background:#ccccff;
	float:center;position: absolute;z-index:99;top:20px;left:0;right:0;
...
<ul id="dropdown4" class="dropdown-content dropdown-tasks w250">
  <li>
	...
	<?php require_once("php/controller/testmysqlconnection.php")?>
	...
	<?php	
		$sql="select * from news_item";//order by _id desc
		$result=mysqli_query($db,$sql);
		while($rs=mysqli_fetch_object($result)){
			echo "<tr class='odd gradeX'><td class='center'>";
			echo $rs->id;
			echo "</td><td>";
			echo $rs->title;
			echo "</td><td>";
			...
			echo $rs->pictures;
			echo "</td><td>";
			echo trim(mb_substr($rs->content,0,20,"utf-8"))."...";
			echo "</td><td>";
			echo "<input type='button' onClick='window.location.href=\"edit.php?row=$rs->id\"' value='编辑'>";
			echo "<input type='button' onClick='window.location.href=\"php/controller/delete.php?row=$rs->id\"' value='删除'>";
			//window.location.href=\"php/controller/delete.php?row=$rs->id\"
			echo "</td>";			
		}
